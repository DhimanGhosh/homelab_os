...
from .config import DB_PATH, DEFAULT_SCORE_SETTINGS
...
CREATE TABLE IF NOT EXISTS books (
    ...
    mood TEXT DEFAULT '',
    english_label TEXT DEFAULT 'Moderate',
    english_ease_score INTEGER DEFAULT 3,
    india_set TEXT DEFAULT 'Unknown',
    wow_score INTEGER DEFAULT 3,
    emotional_score INTEGER DEFAULT 3,
    sadness_score INTEGER DEFAULT 2,
    realism_score INTEGER DEFAULT 3,
    personalized_score REAL DEFAULT 0,
