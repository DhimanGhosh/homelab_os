...
from core.services.proxy import CaddyService
from core.services.recovery import install_recovery_system
...
ExecStart={python} -m core.watchdog_entry
Restart=always
User={user}
